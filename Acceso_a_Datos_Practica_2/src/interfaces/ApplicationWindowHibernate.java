...
public class ApplicationWindowHibernate {
	...
	private void initialize() {
		...
		sl_panelChooseOptions.putConstraint(SpringLayout.NORTH, lblChooseOption, 50, SpringLayout.NORTH, panelChooseOptions);
		lblChooseOption.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblChooseOption.setHorizontalAlignment(SwingConstants.CENTER);
		sl_panelChooseOptions.putConstraint(SpringLayout.WEST, lblChooseOption, 0, SpringLayout.WEST, panelChooseOptions);
		sl_panelChooseOptions.putConstraint(SpringLayout.EAST, lblChooseOption, 0, SpringLayout.EAST, panelChooseOptions);
		...
		btnCarPanel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(frmHibernateApplication, "Database loading, wait a few seconds", "WARNING", JOptionPane.WARNING_MESSAGE);
				}
			}
		});
		...
		sl_panelChooseOptions.putConstraint(SpringLayout.EAST, btnCarPanel, -100, SpringLayout.EAST, panelChooseOptions);
		...
		sl_panelChooseOptions.putConstraint(SpringLayout.NORTH, btnReservationPanel, 16, SpringLayout.SOUTH, btnClientPanel);
		sl_panelChooseOptions.putConstraint(SpringLayout.WEST, btnReservationPanel, 0, SpringLayout.WEST, btnClientPanel);
		sl_panelChooseOptions.putConstraint(SpringLayout.EAST, btnReservationPanel, 0, SpringLayout.EAST, btnClientPanel);
		...
		btnSearchCar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				tableCarPanel.setModel(carManagment.searchByBrandTable(comboBoxSearchCar.getItemAt(comboBoxSearchCar.getSelectedIndex())));
			}
		});
		...
		btnSearchClient.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (clientManagment.searchByDniTable(textFieldSearchClient.getText()).getRowCount()>0) {	
					...
					JOptionPane.showMessageDialog(frmHibernateApplication, "Client not found", "WARNING", JOptionPane.WARNING_MESSAGE);
				}
			}
		});
		...
		sl_panelReservation.putConstraint(SpringLayout.NORTH, lblReservationPanel, 8, SpringLayout.NORTH, panelReservation);
		sl_panelReservation.putConstraint(SpringLayout.WEST, lblReservationPanel, 0, SpringLayout.WEST, panelReservation);
		sl_panelReservation.putConstraint(SpringLayout.EAST, lblReservationPanel, 0, SpringLayout.EAST, panelReservation);
		...
		sl_panelReservation.putConstraint(SpringLayout.SOUTH, tableReservationPanel, -100, SpringLayout.SOUTH, panelReservation);
		tableReservationPanel.setBorder(UIManager.getBorder("Button.border"));
		sl_panelReservation.putConstraint(SpringLayout.NORTH, tableReservationPanel, 8, SpringLayout.SOUTH, lblReservationPanel);
		sl_panelReservation.putConstraint(SpringLayout.WEST, tableReservationPanel, 8, SpringLayout.WEST, panelReservation);
		sl_panelReservation.putConstraint(SpringLayout.EAST, tableReservationPanel, -8, SpringLayout.EAST, panelReservation);
		
		JScrollPane scrollPaneReservationTable = new JScrollPane(tableReservationPanel);
		sl_panelReservation.putConstraint(SpringLayout.NORTH, scrollPaneReservationTable, 8, SpringLayout.SOUTH, lblReservationPanel);
		sl_panelReservation.putConstraint(SpringLayout.WEST, scrollPaneReservationTable, 8, SpringLayout.WEST, panelReservation);
		sl_panelReservation.putConstraint(SpringLayout.SOUTH, scrollPaneReservationTable, -100, SpringLayout.SOUTH, panelReservation);
		sl_panelReservation.putConstraint(SpringLayout.EAST, scrollPaneReservationTable, -8, SpringLayout.EAST, panelReservation);
		...
		sl_panelReservation.putConstraint(SpringLayout.NORTH, separatorReservationPanel, 8, SpringLayout.SOUTH, tableReservationPanel);
		sl_panelReservation.putConstraint(SpringLayout.WEST, separatorReservationPanel, 0, SpringLayout.WEST, tableReservationPanel);
		sl_panelReservation.putConstraint(SpringLayout.EAST, separatorReservationPanel, 0, SpringLayout.EAST, tableReservationPanel);
		...
		sl_panelReservation.putConstraint(SpringLayout.NORTH, btnAddReservation, 8, SpringLayout.SOUTH, separatorReservationPanel);
		sl_panelReservation.putConstraint(SpringLayout.WEST, btnAddReservation, 0, SpringLayout.WEST, separatorReservationPanel);
		sl_panelReservation.putConstraint(SpringLayout.EAST, btnAddReservation, -195, SpringLayout.EAST, separatorReservationPanel);
		...
		sl_panelReservation.putConstraint(SpringLayout.WEST, btnDeleteReservation, 8, SpringLayout.EAST, btnAddReservation);
		sl_panelReservation.putConstraint(SpringLayout.EAST, btnDeleteReservation, 0, SpringLayout.EAST, separatorReservationPanel);
		sl_panelReservation.putConstraint(SpringLayout.NORTH, btnDeleteReservation, 8, SpringLayout.SOUTH, separatorReservationPanel);
		btnDeleteReservation.setEnabled(false);
		...
		sl_panelReservation.putConstraint(SpringLayout.SOUTH, btnBackReservation, -8, SpringLayout.SOUTH, panelReservation);
		sl_panelReservation.putConstraint(SpringLayout.EAST, btnBackReservation, -8, SpringLayout.EAST, panelReservation);
		...
		sl_panelReservation.putConstraint(SpringLayout.NORTH, comboBoxFilterSearch, 15, SpringLayout.SOUTH, btnAddReservation);
		sl_panelReservation.putConstraint(SpringLayout.WEST, comboBoxFilterSearch, 10, SpringLayout.WEST, panelReservation);
		panelReservation.add(comboBoxFilterSearch);
		
		textFieldSearchReservation = new JTextField();
		sl_panelReservation.putConstraint(SpringLayout.WEST, textFieldSearchReservation, 68, SpringLayout.WEST, panelReservation);
		sl_panelReservation.putConstraint(SpringLayout.EAST, comboBoxFilterSearch, -6, SpringLayout.WEST, textFieldSearchReservation);
		sl_panelReservation.putConstraint(SpringLayout.NORTH, textFieldSearchReservation, 15, SpringLayout.SOUTH, btnAddReservation);
		...
		sl_panelReservation.putConstraint(SpringLayout.NORTH, btnSearchReservation, 13, SpringLayout.SOUTH, btnAddReservation);
		sl_panelReservation.putConstraint(SpringLayout.WEST, btnSearchReservation, 163, SpringLayout.WEST, panelReservation);
		sl_panelReservation.putConstraint(SpringLayout.EAST, textFieldSearchReservation, -6, SpringLayout.WEST, btnSearchReservation);
		...
		btnSubmitAddCar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!licensePlate.isEmpty() && !model.isEmpty() && !color.isEmpty() && !brand.isEmpty()) {
					...
					carManagment.addCar(newCar);
					JOptionPane.showMessageDialog(frmHibernateApplication, "Car added successfully!", "SUCCESSFUL", JOptionPane.INFORMATION_MESSAGE);
				} else {
					JOptionPane.showMessageDialog(frmHibernateApplication, "Empty fields, please fill in all fields", "WARNING", JOptionPane.WARNING_MESSAGE);
				}
				reset();
			}
		});
		...
		sl_panelAddClient.putConstraint(SpringLayout.WEST, textFieldPhoneAdd, 0, SpringLayout.WEST, textFieldAddressAdd);
		sl_panelAddClient.putConstraint(SpringLayout.EAST, textFieldPhoneAdd, 0, SpringLayout.EAST, textFieldAddressAdd);
		...
		btnSubmitAddClient.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!dni.isEmpty() && !name.isEmpty() && !address.isEmpty() && !phone.isEmpty()) {
					...
					clientManagment.addClient(newClient);
					JOptionPane.showMessageDialog(frmHibernateApplication, "Client added successfully!", "SUCCESSFUL", JOptionPane.INFORMATION_MESSAGE);
				} else {
					JOptionPane.showMessageDialog(frmHibernateApplication, "Empty fields, please fill in all fields", "WARNING", JOptionPane.WARNING_MESSAGE);
				}
				reset();
		...
		sl_panelAddClient.putConstraint(SpringLayout.NORTH, btnSubmitAddClient, 50, SpringLayout.SOUTH, textFieldPhoneAdd);
		sl_panelAddClient.putConstraint(SpringLayout.WEST, btnSubmitAddClient, 100, SpringLayout.WEST, separatorAddClient);
		...
		sl_panelAddClient.putConstraint(SpringLayout.NORTH, btnResetAddClient, 0, SpringLayout.NORTH, btnSubmitAddClient);
		sl_panelAddClient.putConstraint(SpringLayout.WEST, btnResetAddClient, 20, SpringLayout.EAST, btnSubmitAddClient);
		...
		sl_panelAddReservation.putConstraint(SpringLayout.NORTH, lblAddReservation, 8, SpringLayout.NORTH, panelAddReservation);
		lblAddReservation.setHorizontalAlignment(SwingConstants.CENTER);
		sl_panelAddReservation.putConstraint(SpringLayout.WEST, lblAddReservation, 0, SpringLayout.WEST, panelAddReservation);
		sl_panelAddReservation.putConstraint(SpringLayout.EAST, lblAddReservation, 0, SpringLayout.EAST, panelAddReservation);
		...
		sl_panelAddReservation.putConstraint(SpringLayout.NORTH, separatorAddReservation, 8, SpringLayout.SOUTH, lblAddReservation);
		sl_panelAddReservation.putConstraint(SpringLayout.WEST, separatorAddReservation, 16, SpringLayout.WEST, panelAddReservation);
		sl_panelAddReservation.putConstraint(SpringLayout.EAST, separatorAddReservation, -16, SpringLayout.EAST, panelAddReservation);
		panelAddReservation.add(separatorAddReservation);

		JLabel lblClientDniAdd = new JLabel("Client Dni:");
		sl_panelAddReservation.putConstraint(SpringLayout.NORTH, lblClientDniAdd, 16, SpringLayout.SOUTH, separatorAddReservation);
		sl_panelAddReservation.putConstraint(SpringLayout.WEST, lblClientDniAdd, 16, SpringLayout.WEST, separatorAddReservation);
		panelAddReservation.add(lblClientDniAdd);

		JLabel lblCarPlateAdd = new JLabel("Car Plate:");
		sl_panelAddReservation.putConstraint(SpringLayout.NORTH, lblCarPlateAdd, 16, SpringLayout.SOUTH, lblClientDniAdd);
		...
		sl_panelAddReservation.putConstraint(SpringLayout.NORTH, lblStartDateAdd, 51, SpringLayout.SOUTH, lblCarPlateAdd);
		...
		sl_panelAddReservation.putConstraint(SpringLayout.NORTH, lblEndDateAdd, 16, SpringLayout.SOUTH, lblStartDateAdd);
		...
		sl_panelAddReservation.putConstraint(SpringLayout.NORTH, comboBoxClientDniAdd, -4, SpringLayout.NORTH, lblClientDniAdd);
		sl_panelAddReservation.putConstraint(SpringLayout.WEST, comboBoxClientDniAdd, 10, SpringLayout.EAST, lblClientDniAdd);
		sl_panelAddReservation.putConstraint(SpringLayout.EAST, comboBoxClientDniAdd, 0, SpringLayout.EAST, separatorAddReservation);
		panelAddReservation.add(comboBoxClientDniAdd);

		comboBoxCarPlateAdd = new JComboBox<String>();
		sl_panelAddReservation.putConstraint(SpringLayout.NORTH, comboBoxCarPlateAdd, -4, SpringLayout.NORTH, lblCarPlateAdd);
		sl_panelAddReservation.putConstraint(SpringLayout.WEST, comboBoxCarPlateAdd, 0, SpringLayout.WEST, comboBoxClientDniAdd);
		sl_panelAddReservation.putConstraint(SpringLayout.EAST, comboBoxCarPlateAdd, -28, SpringLayout.EAST, comboBoxClientDniAdd);
		...
		sl_panelAddReservation.putConstraint(SpringLayout.NORTH, scrollPaneCarList, 8, SpringLayout.SOUTH, comboBoxCarPlateAdd);
		sl_panelAddReservation.putConstraint(SpringLayout.WEST, scrollPaneCarList, 0, SpringLayout.WEST, comboBoxCarPlateAdd);
		sl_panelAddReservation.putConstraint(SpringLayout.EAST, scrollPaneCarList, 0, SpringLayout.EAST, separatorAddReservation);
		panelAddReservation.add(scrollPaneCarList);
		
		textFieldStartDateAdd = new JTextField();
		sl_panelAddReservation.putConstraint(SpringLayout.SOUTH, scrollPaneCarList, -8, SpringLayout.NORTH, textFieldStartDateAdd);
		sl_panelAddReservation.putConstraint(SpringLayout.SOUTH, carList, -6, SpringLayout.NORTH, textFieldStartDateAdd);
		sl_panelAddReservation.putConstraint(SpringLayout.NORTH, textFieldStartDateAdd, -4, SpringLayout.NORTH, lblStartDateAdd);
		sl_panelAddReservation.putConstraint(SpringLayout.WEST, textFieldStartDateAdd, 10, SpringLayout.EAST, lblStartDateAdd);
		sl_panelAddReservation.putConstraint(SpringLayout.EAST, textFieldStartDateAdd, -16, SpringLayout.EAST, panelAddReservation);
		panelAddReservation.add(textFieldStartDateAdd);
		textFieldStartDateAdd.setColumns(10);

		textFieldEndDateAdd = new JTextField();
		sl_panelAddReservation.putConstraint(SpringLayout.NORTH, textFieldEndDateAdd, -4, SpringLayout.NORTH, lblEndDateAdd);
		sl_panelAddReservation.putConstraint(SpringLayout.WEST, textFieldEndDateAdd, 0, SpringLayout.WEST, textFieldStartDateAdd);
		sl_panelAddReservation.putConstraint(SpringLayout.EAST, textFieldEndDateAdd, 0, SpringLayout.EAST, textFieldStartDateAdd);
		...
		sl_panelAddReservation.putConstraint(SpringLayout.SOUTH, btnBackAddReservation, -16, SpringLayout.SOUTH, panelAddReservation);
		sl_panelAddReservation.putConstraint(SpringLayout.EAST, btnBackAddReservation, -16, SpringLayout.EAST, panelAddReservation);
		...
		btnSubmitAddReservation.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (isValidFormat("dd-MM-yyyy", startDate, Locale.getDefault()) && isValidFormat("dd-MM-yyyy", endDate, Locale.getDefault())) {
					...
					if (!cars.isEmpty()) {
						...
						JOptionPane.showMessageDialog(frmHibernateApplication, "Reservation successful!", "SUCCESSFUL", JOptionPane.INFORMATION_MESSAGE);
					} else {
						JOptionPane.showMessageDialog(frmHibernateApplication, "You must add at least one car to the reservation", "WARNING", JOptionPane.WARNING_MESSAGE);
					}
				} else {
					JOptionPane.showMessageDialog(frmHibernateApplication, "Invalid date format (Valid format: dd-MM-yyyy)", "WARNING", JOptionPane.WARNING_MESSAGE);
				}
				reset();
			}
		});
		sl_panelAddReservation.putConstraint(SpringLayout.NORTH, btnSubmitAddReservation, 20, SpringLayout.SOUTH, textFieldEndDateAdd);
		sl_panelAddReservation.putConstraint(SpringLayout.NORTH, btnResetAddReservation, 0, SpringLayout.NORTH, btnSubmitAddReservation);
		sl_panelAddReservation.putConstraint(SpringLayout.WEST, btnResetAddReservation, 20, SpringLayout.EAST, btnSubmitAddReservation);
		sl_panelAddReservation.putConstraint(SpringLayout.WEST, btnSubmitAddReservation, 100, SpringLayout.WEST, separatorAddReservation);
		...
		btnAddCarReservation.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (!licensePlateList.contains((String) comboBoxCarPlateAdd.getSelectedItem())) {
					...
					JOptionPane.showMessageDialog(frmHibernateApplication, "Car already selected", "WARNING", JOptionPane.WARNING_MESSAGE);
				}
				carList.setModel(reservationManagment.addCarPlateList(licensePlateList));
			}
		});
		sl_panelAddReservation.putConstraint(SpringLayout.SOUTH, btnAddCarReservation, 0, SpringLayout.SOUTH, comboBoxCarPlateAdd);
		sl_panelAddReservation.putConstraint(SpringLayout.EAST, btnAddCarReservation, 28, SpringLayout.EAST, comboBoxCarPlateAdd);
		...
		sl_panelModifyClient.putConstraint(SpringLayout.NORTH, lblModifyClient, 8, SpringLayout.NORTH, panelModifyClient);
		...
		sl_panelModifyClient.putConstraint(SpringLayout.NORTH, separatorModifyClient, 8, SpringLayout.SOUTH, lblModifyClient);
		sl_panelModifyClient.putConstraint(SpringLayout.WEST, separatorModifyClient, 16, SpringLayout.WEST, panelModifyClient);
		sl_panelModifyClient.putConstraint(SpringLayout.EAST, separatorModifyClient, -16, SpringLayout.EAST, panelModifyClient);
		panelModifyClient.add(separatorModifyClient);
		
		JLabel lblDniModify = new JLabel("DNI:");
		sl_panelModifyClient.putConstraint(SpringLayout.NORTH, lblDniModify, 16, SpringLayout.SOUTH, separatorModifyClient);
		sl_panelModifyClient.putConstraint(SpringLayout.WEST, lblDniModify, 16, SpringLayout.WEST, separatorModifyClient);
		...
		sl_panelModifyClient.putConstraint(SpringLayout.NORTH, lblPhoneModify, 16, SpringLayout.SOUTH, lblAddressModify);
		...
		sl_panelModifyClient.putConstraint(SpringLayout.NORTH, textFieldDniModify, -4, SpringLayout.NORTH, lblDniModify);
		sl_panelModifyClient.putConstraint(SpringLayout.WEST, textFieldDniModify, 10, SpringLayout.EAST, lblDniModify);
		sl_panelModifyClient.putConstraint(SpringLayout.EAST, textFieldDniModify, 0, SpringLayout.EAST, separatorModifyClient);
		...
		sl_panelModifyClient.putConstraint(SpringLayout.NORTH, textFieldNameModify, -4, SpringLayout.NORTH, lblNameModify);
		sl_panelModifyClient.putConstraint(SpringLayout.WEST, textFieldNameModify, 0, SpringLayout.WEST, textFieldDniModify);
		sl_panelModifyClient.putConstraint(SpringLayout.EAST, textFieldNameModify, 0, SpringLayout.EAST, textFieldDniModify);
		textFieldNameModify.setColumns(10);
		panelModifyClient.add(textFieldNameModify);
		
		textFieldAddressModify = new JTextField();
		sl_panelModifyClient.putConstraint(SpringLayout.NORTH, textFieldAddressModify, -4, SpringLayout.NORTH, lblAddressModify);
		sl_panelModifyClient.putConstraint(SpringLayout.WEST, textFieldAddressModify, 0, SpringLayout.WEST, textFieldNameModify);
		sl_panelModifyClient.putConstraint(SpringLayout.EAST, textFieldAddressModify, 0, SpringLayout.EAST, textFieldNameModify);
		textFieldAddressModify.setColumns(10);
		panelModifyClient.add(textFieldAddressModify);
		
		textFieldPhoneModify = new JTextField();
		sl_panelModifyClient.putConstraint(SpringLayout.NORTH, textFieldPhoneModify, -4, SpringLayout.NORTH, lblPhoneModify);
		sl_panelModifyClient.putConstraint(SpringLayout.WEST, textFieldPhoneModify, 0, SpringLayout.WEST, textFieldAddressModify);
		sl_panelModifyClient.putConstraint(SpringLayout.EAST, textFieldPhoneModify, 0, SpringLayout.EAST, textFieldAddressModify);
		...
		btnSubmitModifyClient.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!address.isEmpty() && !phone.isEmpty()) {
					...
					JOptionPane.showMessageDialog(frmHibernateApplication, "Client modification successful!", "SUCCESSFUL", JOptionPane.INFORMATION_MESSAGE);
				} else {
					JOptionPane.showMessageDialog(frmHibernateApplication, "Empty fields, please fill in all fields", "WARNING", JOptionPane.WARNING_MESSAGE);
				}
			}
		});
		sl_panelModifyClient.putConstraint(SpringLayout.NORTH, btnSubmitModifyClient, 50, SpringLayout.SOUTH, textFieldPhoneModify);
		sl_panelModifyClient.putConstraint(SpringLayout.WEST, btnSubmitModifyClient, 100, SpringLayout.WEST, separatorModifyClient);
		...
		sl_panelModifyClient.putConstraint(SpringLayout.NORTH, btnResetModifyClient, 0, SpringLayout.NORTH, btnSubmitModifyClient);
		sl_panelModifyClient.putConstraint(SpringLayout.WEST, btnResetModifyClient, 20, SpringLayout.EAST, btnSubmitModifyClient);
		...
		sl_panelModifyClient.putConstraint(SpringLayout.SOUTH, btnBackModifyClient, -16, SpringLayout.SOUTH, panelModifyClient);
		sl_panelModifyClient.putConstraint(SpringLayout.EAST, btnBackModifyClient, -16, SpringLayout.EAST, panelModifyClient);
	...
	public void reservingDates(String startDate, String endDate) {		
		...
		for (int i=0; i<dates.size(); ++i) {
			reservationDates.add(dates.get(i).format(formatter));
		}
	}
	
	public boolean containsDates(String startDate, String endDate) {
		...
		while (contains == false) {
			for (int i=0; i<dates.size(); ++i) {
				tempList.add(dates.get(i).format(formatter));
				if (reservationDates.contains(tempList.get(i))) {
					contains = true;
				}
			}	
		}
	...
	*/
	public boolean isValidFormat(String format, String value, Locale locale) {
	    try {
    		...
    		JOptionPane.showMessageDialog(frmHibernateApplication, "Invalid date format! (Valid format: dd-MM-yyyy)", "ERROR", JOptionPane.ERROR_MESSAGE);
    		reset();
    	}
	    return false;
	}
